...
!!! tip "استیبل سورت شمارشی"
    این روش مرتب سازی در حالت کلی فقط برای اعداد (به طور خاص `#!cpp int`) کاربرد دارد، ولی می‌توان دید [باکت سورت](/Shaazzz-Guide/Level1/sort/#_23)  حالت کلی تر و استیبل از counting sort است.
...
!!! warning ""
    این سورت تنهای برای اعداد (به طور خاص `#!cpp int`)  قابل استفاده است. اما به نحوی غیر مستقیم در سورت جنس‌های دیگری هم می‌تواند به کار آید که در بخش [ردیکس سورت](/Shaazzz-Guide/Level1/sort/#_27) توضیح داده شده است.
