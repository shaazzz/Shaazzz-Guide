...
برای شروع، استفاده از ادیتور ها و ide هایی همچون Code::Blocks و DevC++ توضیه میشود، همچنین تکست ادیتور هایی مانند Visual Studio Code، Sublime Text و vim نیز میتوانند کمک کننده باشند.
